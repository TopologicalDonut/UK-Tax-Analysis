...
abstract: |
  This report analyzes the impact of the abolition of the 2021 UK tampon tax on prices. In particular, it is found that the elimination of the tax resulted in a roughly 4% decrease in the price of tampons, meaning that a majority of the savings was passed on to the consumers.
---
...
```{r}
#| label: Table for Rebase Example
#| echo: false
```
